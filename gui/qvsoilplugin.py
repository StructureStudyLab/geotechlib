...
from qvsoilwidget import QVSoilWidget

class QVSoilPlugin(QPyDesignerCustomWidgetPlugin):

    """QVSoilPlugin(QPyDesignerCustomWidgetPlugin)
    ...
    def domXml(self):
        return '<widget class="QVSoilWidget" name="qvsoilWidget" />\n'
